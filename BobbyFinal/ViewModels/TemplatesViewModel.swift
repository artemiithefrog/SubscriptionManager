...
class TemplatesViewModel {
    ...
    [
        ...
        Templates(icon: Image(systemName: "icloud.circle"), name: "Apple Music", color: Color(hex: "#000000")),
        Templates(icon: Image(systemName: "icloud.circle"), name: "AT&T", color: Color(hex: "#FF7201")),
        Templates(icon: Image(systemName: "icloud.circle"), name: "Bank of America", color: Color(hex: "#194F90")),
        Templates(icon: Image(systemName: "icloud.circle"), name: "Basecamp", color: Color(hex: "#6FC267")),
        Templates(icon: Image(systemName: "icloud.circle"), name: "Creative Cloud", color: Color(hex: "#D61304")),
        Templates(icon: Image(systemName: "icloud.circle"), name: "Deezer", color: Color(hex: "#010000")),
        Templates(icon: Image(systemName: "icloud.circle"), name: "Dribble", color: Color(hex: "#EA4C89")),
        Templates(icon: Image(systemName: "icloud.circle"), name: "Dropbox", color: Color(hex: "#0161FE")),
        Templates(icon: Image(systemName: "icloud.circle"), name: "Evernote", color: Color(hex: "#7AC142")),
        Templates(icon: Image(systemName: "icloud.circle"), name: "Google Domains", color: Color(hex: "#4285F4")),
        Templates(icon: Image(systemName: "icloud.circle"), name: "Google Drive", color: Color(hex: "#1DA463"))
    ]
